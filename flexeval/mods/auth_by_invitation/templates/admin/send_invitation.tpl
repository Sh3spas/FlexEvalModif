...
{% block content %}
  <h2 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> Send Invitation</h2>
...
For more information concerning our right follow this link: <a href="{{make_url('/legal_terms')}}">{{make_url('/legal_terms')}}</a>
  ...
  <h3 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> Overview</h3>
