...
<h2 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> GCU (Terms of Use)</h2>


{% if get_variable("GCU")["text"] is not none%}
{{get_variable("GCU")["text"]}}
{% else %}
<p>
These terms and conditions outline the rules and regulations for the use of this website, located at {{make_url('/')}}.
...
<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> Cookies</h4>
<p>
We employ the use of cookies.
By accessing this website, you agreed to use cookies in agreement with the The Company's Privacy Policy.
...
<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> License</h4>
<p>
Unless otherwise stated, The Company and/or its licensors own the intellectual property rights for all material on this website.
All intellectual property rights are reserved.
You may access this from this website for your own personal use subjected to restrictions set in these terms and conditions.
</p>
...
<p>
You may found personal data from differents people that have consent to the use of their personal data on this website.
This data are protected by the previous restrictions.
This website is generated dynamicaly for you, and you must not:
</p>

<ul>
  <li>Share your credential, </li>
  <li>Share this website's url, </li>
  <li>Share this website's content, on any support.</li>
</ul>
...
<p>
Parts of this website may offer an opportunity for users to post and exchange opinions, information and files in certain areas of the website.
The terminology "Comments" refere to the previously defined opinions, informations and files.
</p>
...
To the extent permitted by applicable laws, The Company shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
...
<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> Hyperlinking to our Content</h4>
<p>
Any link to our Website required a prior written approval; with consideration any privacy policy that apply to the personal data that can be found on this website.
</p>
...
<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> iFrames</h4>
<p>
Without prior approval and written permission, you may not create frames around our Webpages.
</p>

<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> Content Liability</h4>
...
<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> Your Privacy</h4>
<p>
Please read Privacy Policy
</p>

<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> Reservation of Rights</h4>
<p>
We reserve the right to request that you remove all links or any particular link to our Website. You approve to immediately remove all links to our Website upon request. We also reserve the right to amen these terms and conditions and it’s linking policy at any time. By continuously linking to our Website, you agree to be bound to and follow these linking terms and conditions.
</p>


<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> Removal of links from our website</h4>
<p>
...
<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> Disclaimer</h4>
<p>
...
<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> How to contact us?</h4>
<p>
  If you have any questions about our Terms of Use, please do not hesitate to contact us, by the following means:
  <ul>
...
<p>Source : <a href="https://www.termsandconditionsgenerator.com">https://www.termsandconditionsgenerator.com</a>

{% endif %}
<h2 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> Privacy Policy</h2>
...
<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> Who we are?</h4>
<p>
...
<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> What data we collect?</h4>
<p>
...
<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> How do we collect your data?</h4>
<p>
...
<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> How will we use your data?</h4>
<p>
  {{gdpr["data_collection"]["purpose"]}}
</p>

<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> How do we store your data?</h4>
<p>
...
<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> What are your data protection rights?</h4>
<p>
...
<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> What are cookies?</h4>
<p>
...
<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> How do we use cookies?</h4>
<p>
...
<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> What types of cookies do we use?</h4>
<p>
...
<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> How to manage your cookies?</h4>
<p>
...
<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> Privacy policies of other websites.</h4>
<p>
...
<h4 class="bd-content-title"> <i class="bi bi-caret-right-fill icon-chevron-title"></i> How to contact the appropriate authority?</h4>
